        ...
        >
            ...
            <Modal.Body>
                ...
                <table>
                    ...
                    <tr>
                        <td style={{ float: 'right', fontSize: '17px', width:'90px', textAlign:'right' }}>Language :&nbsp; </td>
                    ...
                    <tr>
                        ...
                        <td style={{ fontWeight: '500', paddingLeft: '10px', fontSize: '18px' }}>{bookDetails?.category?.map((val, index) => { return <span key={index}>{index > 0 ? ', ' : null}{val.name}</span> })}</td>
                    </tr>
                    <tr>
                        <td style={{ float: 'right', fontSize: '17px' }}>Status :&nbsp; </td>
                        <td style={{ fontWeight: '500', paddingLeft: '10px', fontSize: '18px' }}>{bookDetails?.quantity > 0 ? <span style={{ 'backgroundColor': 'transparent', 'color': 'green', 'padding': '0' }}>AVAILABLE</span> : <span style={{ 'backgroundColor': 'transparent', 'color': 'red', 'padding': '0' }}>NOT AVAILABLE</span>}</td>
                    </tr>
                </table>
            </Modal.Body>
            <Modal.Footer>
